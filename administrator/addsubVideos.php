...
// }
  elseif (count($error)==0) {
    ...
    $vd_insert="INSERT INTO `sub_videos`(`title`, `url`, `image`, `main`) VALUES ('".$vdoname."','".$vdUrl."','".$file."','".$main_id."') ";
...
<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Add New Sub Videos</h1>
      </div>
          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
             ...
             <select id="selectbasic" name="main" class="form-control" value="<?php echo $main_id; ?>">
              ...
              <?php 
              $get_category="select * from videos ORDER BY id DESC";
