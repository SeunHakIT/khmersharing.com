...
if(isset($_POST['save'])){
  ...
  $update="UPDATE `videos` SET `title`='".$vdoname."',`image`='".$file."',`url`='".$vdUrl."',`category`='".$vdCat."' WHERE  `id`='".$id."' ";
...
<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Update Videos</h1>
      </div>
      ...
      <div class="col-md-6">
        <div class="panel panel-default">
          <form role="form" action="" method="post" enctype="multipart/form-data">
            ...
            if($_GET['u']){
              $get_id=$_GET['u'];
              $select="SELECT * FROM `videos` WHERE id='".$get_id."' ";
